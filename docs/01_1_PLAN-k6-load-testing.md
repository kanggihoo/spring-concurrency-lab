...
- [x] **Task 2: k6 - Prometheus 메트릭 수집 연동**
...
- [x] Prometheus의 `enable-remote-write` 옵션이 적용되었는지 확인.
- [x] 컨테이너 네트워크 간에 포트가 정상 매핑되어 데이터가 전송되는지 확인.
- [x] Socratic Gate (API 상세 설정, 목표 수치 결정 등) 완료 및 반영.
